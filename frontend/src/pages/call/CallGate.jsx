  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-10 bg-[#1b171c] px-8">
      <div className="flex flex-col items-center gap-6">
        <div className="flex size-[210px] items-center justify-center overflow-hidden rounded-full bg-white/10 text-[100px]">
          {persona?.image ? (
            <img src={persona.image} alt="" className="size-[180px] object-contain" />
          ) : (
            persona?.emoji ?? '👻'
          )}
        </div>
